...
class _MyGoalsPageState extends State<MyGoalsPage> {
  ...
  void editWithIntField(String title, int? currentValue, String? unit,
      Function(int?) onEnteredValue) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          Container(height: 20),
          buildCard("Current Weight ",
              CurrentSession.currentProfile.currentWeight.toString() + " lbs",
              () {
            editWithIntField("Enter Current Weight",
                CurrentSession.currentProfile.currentWeight, "lbs", (str) {
              setState(() {
          ...
          Container(height: 20),
          buildCard("Weight Goal ",
              CurrentSession.currentProfile.weightGoal.toString(), () {
            editWithRadioField(
                "Enter Current Weight",
                CurrentSession.currentProfile.weightGoal,
                ["Gain", "Maintain", "Lose"], (str) {
              setState(() {
          ...
          Container(height: 20),
          buildCard("Weight Rate Goal ",
              CurrentSession.currentProfile.weightGoalRate.toString(), () {
            editWithRadioField(
                "Enter Weekly Rate Goal",
                CurrentSession.currentProfile.weightGoal,
                ["1/2 lb", "1 lb", "1.5 lbs"], (str) {
              setState(() {
